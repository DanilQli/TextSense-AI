// *********************************************************************// *                        WARNING !!!                               *// *   ЭТОТ ФАЙЛ СГЕНЕРИРОВАН АВТОМАТИЧЕСКИ. НЕ РЕДАКТИРУЙТЕ ЕГО ВРУЧНУЮ  *// *   Код собран из множества .dart файлов в директории lib/            *// *   Чтобы пересобрать, запустите скрипт build_all_dart.py             *// *********************************************************************
